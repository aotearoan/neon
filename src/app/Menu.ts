            ...
            children: [
              {
                ...
                keywords: 'filter menu navigation',
              },
              {
                path: 'anchor',
                page: 'Anchor',
              ...
              },
              {
                ...
                page: 'MobileMenu',
                name: 'Mobile Menu',
                keywords: 'mobile menu navigation',
              ...
              },
              {
                ...
                keywords: 'wizard progress navigation',
              },
              {
                path: 'tree-menu',
                page: 'TreeMenu',
