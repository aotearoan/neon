<template>
  <component-documentation v-if="menuModel" :headline="headline" :model="menuModel" class="search-examples">
    <neon-card>
      <neon-card-body>
        <p>
          The <strong>NeonSearch</strong> component is equivalent to an HTML &lt;input type="search"&gt; element. It is
          useful as an alternative to <em>NeonSelect</em> to provide filtered results when the universe of results is
          very large and/or the results need to be requested from a server side API.
        </p>
      ...
      <neon-card-body>
        ...
        <div class="neon-vertically-spaced">
          <neon-search
            ...
            :multiple="true"
            :options="filterOptions(coloredChips, searchColored, filterColored, true)"
            placeholder="Search"
