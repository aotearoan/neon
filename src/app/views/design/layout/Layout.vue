<template>
  <neon-card>
    ...
    <neon-card-body>
      ...
      <p>
        Neon provides a default page layout. Adhering to this structure ensures the provided responsive behaviour is
        preserved. Most of the layout is structured using component slots with the exception of the NeonPage #content
        slot. This is left open for any content, however if you choose to use NeonGrid and NeonFooter providing these
        directly in the NeonPage #content slot will preserve the responsiveness of the page.
      </p>
      <p>The recommended desktop (i.e. larger-than-tablet size) component/slot layout is as follows:</p>
      <div class="layout-example">
        ...
        <div class="layout-example__content">
          <div class="layout-example layout-example__side-nav">
            <span class="layout-example__label"
              >#side-nav (<neon-link class="layout-example__link" href="/layout/side-nav">NeonSideNav</neon-link>)</span
            >
    ...
    <neon-card-body>
      <neon-anchor id="responsive-layout" />
      <h2 class="neon-h4">Responsive layout</h2>
      <p>
        The <em>responsive</em> layout is the same as the desktop layout with the exception of the Side Nav being
        removed due to the narrower width. Instead of displaying the Side Nav at smaller screen sizes it is recommended
        to provide the side navigation content in a <neon-link href="/layout/drawer">NeonDrawer</neon-link> component
        triggered by a <neon-link href="/user-input/button">NeonButton</neon-link>.
      </p>
      <div class="layout-example">
        <neon-link class="layout-example__label" href="/layout/page">NeonPage</neon-link>
        <div class="layout-example">
    ...
    <neon-card-body>
      ...
      <p>
        ...
        <neon-link href="/layout/grid">NeonGrid</neon-link> is a CSS Grid based container designed to help simplify page
        application layout and responsiveness by abstracting CSS Grid and allowing applications to define this
      ...
      <p>
        ...
        complexities of using it directly.
      </p>
      <p>
