<template>
  <neon-card>
    ...
    <neon-card-body>
      ...
      <h2>Dark mode</h2>
      <p>
        Neon supports both light and dark modes for each theme. These are supported by changing the mode class attached
        to the body of the page. The classes are <em class="neon-color-text-info">neon-mode--light</em> and
        <em class="neon-color-text-info">neon-mode--dark</em>
      </p>
