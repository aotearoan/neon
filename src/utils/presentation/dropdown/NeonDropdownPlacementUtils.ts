import { NeonDropdownPlacementObject } from '@/model/presentation/dropdown/NeonDropdownPlacementObject';
import { NeonPosition } from '@/model/common/position/NeonPosition';
import type { NeonDropdownPlacement } from '@/model/presentation/dropdown/NeonDropdownPlacement';
import type { NeonAvailableSpace } from '@/model/common/dom/NeonAvailableSpace';
import { NeonPlacementUtils } from '@/utils/common/dom/NeonPlacementUtils';
