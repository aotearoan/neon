...
describe('NeonExpansionPanel', () => {
  ...
  describe('invalid cases', () => {
    it('should log an error when label or header is not provided', () => {
  ...
  describe('valid cases', () => {
    ...
    it('renders indicator position', async () => {
      // given
      const indicatorPosition = NeonHorizontalPosition.Left;
      const { container, rerender } = harness;
      await rerender({ indicatorPosition });
      // when / then
      expect(container.querySelector(`.neon-expansion-panel__header--${indicatorPosition}`)).toBeDefined();
    });
