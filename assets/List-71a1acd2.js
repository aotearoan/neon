import{N as k,a as N,b as g}from"./NeonCardHeader-0e07b06c.js";import{N as y}from"./NeonList-1ffbbc47.js";import{N as _}from"./NeonStack-fb7ab566.js";import{M as E,_ as L}from"../index.js";import{C as U}from"./ComponentDocumentation-ff2d7d8a.js";import{E as w}from"./Editor-b0914283.js";import{u as z,R as a,S as M,D as i,F as B,G as s,A as $,x as D,L as n,H as t,a2 as b}from"./vendor-7a8d752b.js";import"./NeonLabel-b5124cd8.js";import"./NeonNote-1fc9d984.js";import"./NeonTabs-e718f442.js";const H=z({name:"List",components:{NeonCard:k,NeonCardBody:N,NeonCardHeader:g,NeonList:y,NeonStack:_,ComponentDocumentation:U,Editor:w},setup(){const e=a(null),o=a("A vertical list of removable items"),d=a([{key:"key1",label:"Item 1"},{key:"key2",label:"Item 2"},{key:"key3",label:"Item 3"},{key:"key4",label:"Item 4"}]),I=a([...d.value]),c=a([...d.value]),f=a([...d.value]),r=a([...d.value]),m=a([...d.value]),u=a([...d.value]),p=a([...d.value]),C=v=>console.log(`${v} removed`),V=`<neon-list v-model="smallItems"
           size="s"
           @close="onClose"
/>
